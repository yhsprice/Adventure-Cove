...
{ question: "How many Earths could fit inside Jupiter?", choices: ["About 10", "About 100", "About 1,300", "About 10,000"], answer: 2 },
  { question: "Who was the first President of the United States?", choices: ["John Adams", "Thomas Jefferson", "George Washington", "James Madison"], answer: 2 },
{ question: "In what year did the United States declare independence?", choices: ["1776", "1783", "1801", "1812"], answer: 0 },
{ question: "Who wrote the Declaration of Independence?", choices: ["George Washington", "Benjamin Franklin", "Thomas Jefferson", "John Hancock"], answer: 2 },
{ question: "Which ship carried the Pilgrims to America?", choices: ["Mayflower", "Santa Maria", "Titanic", "Endeavour"], answer: 0 },
{ question: "Who was known as Honest Abe?", choices: ["Washington", "Lincoln", "Grant", "Roosevelt"], answer: 1 },

{ question: "Which war was fought between the North and South in the U.S.?", choices: ["Revolutionary War", "Civil War", "War of 1812", "World War I"], answer: 1 },
{ question: "Who was the first man to walk on the moon?", choices: ["Buzz Aldrin", "John Glenn", "Neil Armstrong", "Alan Shepard"], answer: 2 },
{ question: "Which country built the Great Pyramid of Giza?", choices: ["Greece", "Rome", "Egypt", "Persia"], answer: 2 },
{ question: "What wall fell in 1989?", choices: ["Great Wall", "Berlin Wall", "Hadrian's Wall", "Wall of Troy"], answer: 1 },
{ question: "Who discovered America for Europe in 1492?", choices: ["Magellan", "Columbus", "Cook", "Drake"], answer: 1 },

{ question: "Who was the first female pilot to fly solo across the Atlantic?", choices: ["Amelia Earhart", "Sally Ride", "Bessie Coleman", "Harriet Quimby"], answer: 0 },
{ question: "Which ancient civilization built Machu Picchu?", choices: ["Aztec", "Maya", "Inca", "Roman"], answer: 2 },
{ question: "What ship sank in 1912 after hitting an iceberg?", choices: ["Lusitania", "Mayflower", "Titanic", "Bismarck"], answer: 2 },
{ question: "Who was the leader of Nazi Germany?", choices: ["Stalin", "Hitler", "Mussolini", "Kaiser Wilhelm"], answer: 1 },
{ question: "What was the name of the first successful English colony in America?", choices: ["Plymouth", "Roanoke", "Jamestown", "Boston"], answer: 2 },

{ question: "Which U.S. President freed the slaves?", choices: ["Washington", "Lincoln", "Grant", "Jefferson"], answer: 1 },
{ question: "Which country gifted the Statue of Liberty to the U.S.?", choices: ["England", "Germany", "France", "Spain"], answer: 2 },
{ question: "What was the first state admitted to the Union?", choices: ["Virginia", "Pennsylvania", "Delaware", "New York"], answer: 2 },
{ question: "Who painted the Mona Lisa?", choices: ["Michelangelo", "Da Vinci", "Raphael", "Donatello"], answer: 1 },
{ question: "Which civilization built the Colosseum?", choices: ["Greek", "Roman", "Egyptian", "Persian"], answer: 1 },

{ question: "Who was the first woman on the U.S. Supreme Court?", choices: ["Sandra Day O'Connor", "Ruth Bader Ginsburg", "Sonia Sotomayor", "Elena Kagan"], answer: 0 },
{ question: "What year did World War II end?", choices: ["1942", "1945", "1948", "1950"], answer: 1 },
{ question: "Who was known as the Maid of Orleans?", choices: ["Marie Curie", "Joan of Arc", "Queen Elizabeth", "Catherine the Great"], answer: 1 },
{ question: "Which empire was ruled by Julius Caesar?", choices: ["Greek", "Roman", "Ottoman", "British"], answer: 1 },
{ question: "What was the name of the trade route between Europe and Asia?", choices: ["Spice Trail", "Silk Road", "King's Way", "Royal Route"], answer: 1 },

{ question: "Who invented the telephone?", choices: ["Edison", "Bell", "Tesla", "Marconi"], answer: 1 },
{ question: "Who was the first President to live in the White House?", choices: ["Washington", "Jefferson", "Adams", "Madison"], answer: 2 },
{ question: "What document begins with 'We the People'?", choices: ["Declaration of Independence", "Constitution", "Bill of Rights", "Gettysburg Address"], answer: 1 },
{ question: "Which explorer circumnavigated the globe first?", choices: ["Columbus", "Magellan Expedition", "Cook", "Vespucci"], answer: 1 },
{ question: "Which war was called the Great War before WWII?", choices: ["Civil War", "World War I", "War of 1812", "Crimean War"], answer: 1 },

{ question: "Who was Cleopatra?", choices: ["Roman Empress", "Queen of Egypt", "Greek Philosopher", "Persian Princess"], answer: 1 },
{ question: "What was the name of the ship Charles Darwin sailed on?", choices: ["Beagle", "Endeavour", "Victory", "Discovery"], answer: 0 },
{ question: "Who delivered the Gettysburg Address?", choices: ["Grant", "Washington", "Lincoln", "Jefferson"], answer: 2 },
{ question: "Which U.S. President appears on the $20 bill?", choices: ["Lincoln", "Jackson", "Grant", "Jefferson"], answer: 1 },
{ question: "What was the capital of the Roman Empire?", choices: ["Athens", "Rome", "Constantinople", "Alexandria"], answer: 1 },

{ question: "Who invented the light bulb most commonly credited in schools?", choices: ["Tesla", "Edison", "Bell", "Ford"], answer: 1 },
{ question: "Which ancient wonder was located in Babylon?", choices: ["Colossus", "Hanging Gardens", "Lighthouse", "Temple of Artemis"], answer: 1 },
{ question: "What year did the U.S. enter World War II?", choices: ["1939", "1940", "1941", "1942"], answer: 2 },
{ question: "Who was the first emperor of Rome?", choices: ["Caesar", "Augustus", "Nero", "Trajan"], answer: 1 },
{ question: "What famous speech begins 'Four score and seven years ago'?", choices: ["I Have a Dream", "Gettysburg Address", "Farewell Address", "Inaugural Address"], answer: 1 },

{ question: "Who sailed the Santa Maria?", choices: ["Magellan", "Cook", "Columbus", "Drake"], answer: 2 },
{ question: "What was the name of the first successful airplane?", choices: ["Flyer", "Spirit", "Eagle", "Pioneer"], answer: 0 },
{ question: "Which queen ruled England during the Spanish Armada?", choices: ["Victoria", "Elizabeth I", "Mary", "Anne"], answer: 1 },
{ question: "Who purchased Louisiana for the United States?", choices: ["Washington", "Jefferson", "Lincoln", "Monroe"], answer: 1 },
{ question: "What was the name of the German airship that exploded in 1937?", choices: ["Zeppelin", "Hindenburg", "Graf", "Titan"], answer: 1 },

{ question: "Which city was buried by Mount Vesuvius?", choices: ["Athens", "Pompeii", "Rome", "Sparta"], answer: 1 },
{ question: "Who led the Continental Army?", choices: ["Adams", "Washington", "Jefferson", "Franklin"], answer: 1 },
{ question: "Which amendment gave women the right to vote in the U.S.?", choices: ["15th", "18th", "19th", "21st"], answer: 2 },
{ question: "What year was the U.S. Constitution signed?", choices: ["1776", "1787", "1791", "1800"], answer: 1 },
{ question: "Which famous civil rights leader gave the 'I Have a Dream' speech?", choices: ["Malcolm X", "Martin Luther King Jr.", "Rosa Parks", "Thurgood Marshall"], answer: 1 },
  { question: "What has keys but cannot open locks?", choices: ["Piano", "Map", "Clock", "Book"], answer: 0 },
{ question: "What gets wetter the more it dries?", choices: ["Sponge", "Towel", "Soap", "Rain"], answer: 1 },
{ question: "What has a face and hands but no arms or legs?", choices: ["Clock", "Doll", "Mirror", "Robot"], answer: 0 },
{ question: "What can travel around the world while staying in a corner?", choices: ["Stamp", "Plane", "Compass", "Map"], answer: 0 },
{ question: "What has a neck but no head?", choices: ["Bottle", "Shirt", "Guitar", "All of these"], answer: 3 },

{ question: "What comes once in a minute, twice in a moment, but never in a thousand years?", choices: ["Time", "The letter M", "A second", "The moon"], answer: 1 },
{ question: "What has many teeth but cannot bite?", choices: ["Comb", "Shark", "Saw", "Zipper"], answer: 0 },
{ question: "What has one eye but cannot see?", choices: ["Needle", "Storm", "Potato", "Button"], answer: 0 },
{ question: "What begins with T, ends with T, and has T in it?", choices: ["Tent", "Teapot", "Toast", "Ticket"], answer: 1 },
{ question: "What can you catch but not throw?", choices: ["Cold", "Ball", "Fish", "Frisbee"], answer: 0 },

{ question: "What has words but never speaks?", choices: ["Book", "Parrot", "Radio", "Phone"], answer: 0 },
{ question: "What has a head and a tail but no body?", choices: ["Snake", "Coin", "Dog", "Arrow"], answer: 1 },
{ question: "What runs but never walks?", choices: ["Water", "Dog", "Clock", "Car"], answer: 0 },
{ question: "What can fill a room but takes up no space?", choices: ["Air", "Light", "Furniture", "Sound"], answer: 1 },
{ question: "What is always in front of you but cannot be seen?", choices: ["Future", "Air", "Shadow", "Road"], answer: 0 },

{ question: "What has branches but no fruit, trunk, or leaves?", choices: ["Bank", "Tree", "River", "Library"], answer: 0 },
{ question: "What has cities but no houses, forests but no trees, and water but no fish?", choices: ["Map", "Globe", "Book", "Painting"], answer: 0 },
{ question: "What is full of holes but still holds water?", choices: ["Net", "Sponge", "Bucket", "Cup"], answer: 1 },
{ question: "What question can you never answer yes to?", choices: ["Are you asleep?", "Are you hungry?", "Are you ready?", "Are you here?"], answer: 0 },
{ question: "What becomes smaller every time it takes a bath?", choices: ["Soap", "Towel", "Sponge", "Ice"], answer: 0 },

{ question: "What has legs but does not walk?", choices: ["Table", "Horse", "Chair", "Both table and chair"], answer: 3 },
{ question: "What has ears but cannot hear?", choices: ["Corn", "Dog", "Rabbit", "Phone"], answer: 0 },
{ question: "What has a ring but no finger?", choices: ["Phone", "Bell", "Tree", "All of these"], answer: 3 },
{ question: "What has a bed but never sleeps?", choices: ["River", "Dog", "Hotel", "Person"], answer: 0 },
{ question: "What has a mouth but never eats?", choices: ["River", "Fish", "Cave", "Cup"], answer: 0 },

{ question: "What goes up but never comes down?", choices: ["Age", "Balloon", "Smoke", "Elevator"], answer: 0 },
{ question: "What belongs to you but other people use it more than you do?", choices: ["Name", "Phone", "Shoes", "Car"], answer: 0 },
{ question: "What has four wheels and flies?", choices: ["Airplane", "Garbage truck", "Race car", "Toy car"], answer: 1 },
{ question: "What can be cracked, made, told, and played?", choices: ["Joke", "Egg", "Code", "Game"], answer: 0 },
{ question: "What gets sharper the more you use it?", choices: ["Brain", "Knife", "Pencil", "Scissors"], answer: 0 },

{ question: "What has 13 hearts but no organs?", choices: ["Deck of cards", "Robot", "Clock", "Puzzle"], answer: 0 },
{ question: "What has a thumb and four fingers but is not alive?", choices: ["Glove", "Hand", "Robot", "Doll"], answer: 0 },
{ question: "What can you break without touching it?", choices: ["Promise", "Glass", "Stick", "Egg"], answer: 0 },
{ question: "What has an end but no beginning?", choices: ["Stick", "Circle", "Road", "Rainbow"], answer: 0 },
{ question: "What has no life but can die?", choices: ["Battery", "Tree", "Fish", "Flower"], answer: 0 },

{ question: "The more you take, the more you leave behind. What are they?", choices: ["Steps", "Coins", "Pictures", "Notes"], answer: 0 },
{ question: "What has a bottom at the top?", choices: ["Legs", "Bottle", "Mountain", "Chair"], answer: 0 },
{ question: "What word is spelled wrong in every dictionary?", choices: ["Wrong", "Dictionary", "Every", "Spelled"], answer: 0 },
{ question: "What can point in every direction but cannot reach the destination?", choices: ["Compass", "Finger", "Arrow", "Map"], answer: 0 },
{ question: "What kind of coat is always wet when you put it on?", choices: ["Paint", "Raincoat", "Winter coat", "Boat coat"], answer: 0 },

{ question: "What is bought by the yard and worn by the foot?", choices: ["Carpet", "Shoes", "Socks", "Rope"], answer: 0 },
{ question: "What is easy to lift but hard to throw?", choices: ["Feather", "Pillow", "Paper", "Balloon"], answer: 0 },
{ question: "What comes down but never goes up?", choices: ["Rain", "Age", "Smoke", "Balloon"], answer: 0 },
{ question: "What has holes on the top, bottom, left, right, and middle but still holds water?", choices: ["Sponge", "Net", "Cup", "Basket"], answer: 0 },
{ question: "What can you keep after giving it to someone?", choices: ["Your word", "A gift", "Money", "A pencil"], answer: 0 },

{ question: "What gets bigger the more you take away from it?", choices: ["Hole", "Pile", "Box", "Shadow"], answer: 0 },
{ question: "What is black when clean and white when dirty?", choices: ["Chalkboard", "Paper", "Window", "Shoe"], answer: 0 },
{ question: "What has a spine but no bones?", choices: ["Book", "Fish", "Backpack", "Snake"], answer: 0 },
{ question: "What has a foot but no leg?", choices: ["Ruler", "Shoe", "Bed", "Mountain"], answer: 0 },
{ question: "What can be opened but never closed?", choices: ["Egg", "Door", "Window", "Book"], answer: 0 }
  ]
  };
