...
const challenges = [
  ...
  { text: "Bowl the ball. No club.", type: "NORMAL" },
  { text: "Take your second shot with your eyes closed.", type: "NORMAL" },
  { text: "Use your non-dominant hand.", type: "NORMAL" },
  ...
  { text: "Wall First: your first shot must touch a side wall.", type: "NORMAL" },
  ...
  { text: "Leader Trouble: the winning player uses their non-dominant hand first.", type: "NORMAL" },
  { text: "Tap and Freeze: after your first shot, stay still until everyone shoots.", type: "NORMAL" },
  { text: "Player's Choice: each player chooses their own silly first-shot style.", type: "NORMAL" },
  { text: "Straight Arm Shot: keep elbows straight for your first shot.", type: "NORMAL" },
  ...
  { text: "Captain's Call: youngest player picks one rule — one hand, eyes closed, or sideways.", type: "NORMAL" },
  { text: challengeTypes.WATERFALL_WHISPER, type: "WATERFALL_WHISPER" },
  { text: challengeTypes.LUCKY_BOUNCE, type: "LUCKY_BOUNCE" },
  { text: "The Detour: first shot must aim for a wall or obstacle first.", type: "NORMAL" },
  { text: "Steady Captain: keep both hands touching on the putter all hole.", type: "NORMAL" }
];
